...
const About = () => {
  ...
  const highlights = [
    ...
    },
    {
      ...
      description:
        "Python, Node.js, RESTful APIs, and microservices architecture",
    },
    {
      icon: Database,
    ...
    },
    {
      ...
      title: "Performance",
      description:
        "Optimization, caching, and best practices for fast applications",
    },
    {
      icon: Users,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-fade-up">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              I&apos;m Prince — a tech enthusiast and B.Tech student in VLSI at
              SVNIT. I love building digital solutions through web and app
              development, Python programming, and creative problem-solving. I&apos;m
              always exploring new technologies, from data science to Arduino
              projects, and recently started my freelancing journey to turn my
              passion into real-world experience. My goal is to keep learning,
              growing, and creating meaningful digital experiences.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div className="animate-fade-up">
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  With several years of experience in full stack development,
                ...
                <p>
                  ...
                  crafting intuitive user interfaces with React to building
                  robust backend systems with Python and managing databases with
                  MongoDB.
                </p>
                <p>
                  I&apos;m always eager to learn new technologies and stay
                  updated with the latest industry trends. When I&apos;m not
